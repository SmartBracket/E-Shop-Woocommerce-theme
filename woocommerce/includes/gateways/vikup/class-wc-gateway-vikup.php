 ...
 */
class WC_Gateway_vikup extends WC_Payment_Gateway {
	...
	protected function setup_properties() {
		...
		$this->method_title       = __( 'Выкуп', 'woocommerce' );
		$this->method_description = __( 'Выкуп с аптеки', 'woocommerce' );
	...
	public function change_payment_complete_order_status( $status, $order_id = 0, $order = false ) {
		if ( $order && 'vikup' === $order->get_payment_method() ) {
			$status = 'completed';
		}
		return $status;
	}
